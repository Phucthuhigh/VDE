  ...
  return (
    <div className="fixed inset-0 z-[300] bg-black/70 backdrop-blur-md flex flex-col items-center justify-center p-6 transition-opacity duration-700">
      <div className="flex flex-col items-center">
        <h1 
          className="text-5xl md:text-[6.5rem] font-black text-transparent bg-clip-text bg-gradient-to-b from-red-300 via-rose-500 to-red-800 uppercase tracking-widest text-center leading-normal"
          style={{
